...
var _user$project$Main$filterBy = F2(
	function (model, videos) {
		var hasSpeaker = function (video) {
			return A2(_elm_lang$core$List$member, model.speakerFilter, video.speakers) || _elm_lang$core$Native_Utils.eq(model.speakerFilter, '');
		};
		var bySpeaker = A2(_elm_lang$core$List$filter, hasSpeaker, videos);
		var hasTag = function (video) {
			return A2(_elm_lang$core$List$member, model.tagFilter, video.tags) || _elm_lang$core$Native_Utils.eq(model.tagFilter, '');
		};
		var byTag = A2(_elm_lang$core$List$filter, hasTag, bySpeaker);
		return byTag;
	});
var _user$project$Main$searchFor = F2(
	function (query, videos) {
		var queryTerms = _elm_lang$core$String$words(
			_elm_lang$core$String$toLower(query));
		var matchesQueryTerms = function (_p0) {
			var _p1 = _p0;
			var lowerTags = _elm_lang$core$String$toLower(
				_elm_lang$core$Basics$toString(_p1.tags));
			var lowerSpeakers = _elm_lang$core$String$toLower(
				_elm_lang$core$Basics$toString(_p1.speakers));
			var lowerTitle = _elm_lang$core$String$toLower(_p1.title);
			var findTerm = function (term) {
				return A2(_elm_lang$core$String$contains, term, lowerTitle) || (A2(_elm_lang$core$String$contains, term, lowerSpeakers) || A2(_elm_lang$core$String$contains, term, lowerTags));
			};
			return A2(_elm_lang$core$List$all, findTerm, queryTerms);
		};
		return A2(_elm_lang$core$List$filter, matchesQueryTerms, videos);
	});
var _user$project$Main$youtube = function (id) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$width(560),
						_elm_lang$html$Html_Attributes$height(315),
						_elm_lang$html$Html_Attributes$src(
						A2(_elm_lang$core$Basics_ops['++'], 'https://www.youtube.com/embed/', id))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$Main$videos = _elm_lang$core$Native_List.fromArray(
	[
		{
		date: '2014-09-21',
		added: '2016-04-29',
		...
		speakers: _elm_lang$core$Native_List.fromArray(
			['Evan Czaplicki']),
...
var _user$project$Main$initialModel = {
	videos: _user$project$Main$videos,
	selected: {
		date: '2015-07-14',
		added: '2016-04-29',
		id: 'oYk8CKH7OhE',
...
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {videos: a, selected: b, query: c, tagFilter: d, speakerFilter: e};
	});
var _user$project$Main$Video = F7(
	function (a, b, c, d, e, f, g) {
		return {date: a, added: b, id: c, url: d, speakers: e, tags: f, title: g};
	});
var _user$project$Main$Speaker = {ctor: 'Speaker'};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('header-section')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('page-logo')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[])),
										_elm_lang$html$Html$text('Elm Videos')
									]))
							])),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('search-box')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('fa fa-code-fork')
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
...
var _user$project$Main$view = function (model) {
	var footer = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('page-footer')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Original idea by '),
				A2(
				_elm_lang$html$Html$a,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('https://gophervids.appspot.com')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('GopherVids')
					]))
			]));
	var searchedVideos = A2(_user$project$Main$searchFor, model.query, model.videos);
	var filteredVideos = A2(_user$project$Main$filterBy, model, searchedVideos);
	var selected = model.selected;
	var selectedID = function (v) {
		return _elm_lang$core$Native_Utils.eq(v.id, selected.id) ? 'selected' : 'unselected';
	};
	var videoRow = function (v) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('video-row'),
					_elm_lang$html$Html_Attributes$id(
					selectedID(v)),
					_elm_lang$html$Html_Events$onClick(
					_user$project$Main$Select(v))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text(v.title)
				]));
	};
	var videoList = A2(_elm_lang$core$List$map, videoRow, filteredVideos);
	var body = function () {
		var selectedSpeaker = (!_elm_lang$core$Native_Utils.eq(model.speakerFilter, '')) ? _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('speaker: '),
				_elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], model.speakerFilter, ' ')),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						A2(_user$project$Main$Filter, _user$project$Main$Speaker, ''))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
			...
			[]);
		var selectedTag = (!_elm_lang$core$Native_Utils.eq(model.tagFilter, '')) ? _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('tag: '),
				_elm_lang$html$Html$text(
				A2(_elm_lang$core$Basics_ops['++'], model.tagFilter, ' ')),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(
						A2(_user$project$Main$Filter, _user$project$Main$Tag, ''))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('x')
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(
								A2(_user$project$Main$Filter, _user$project$Main$Tag, x))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(x)
		...
		var tagList = A2(_elm_lang$core$List$map, tags, selected.tags);
		var speakers = function (x) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(
								A2(_user$project$Main$Filter, _user$project$Main$Speaker, x))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(x)
		...
		var speakerList = A2(_elm_lang$core$List$map, speakers, selected.speakers);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('page-body')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('video-player')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html$text(selected.title)
								])),
							_user$project$Main$youtube(selected.id),
							A2(
							_elm_lang$html$Html$div,
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('speaker-list')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('tag-list')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('video-list-container')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('video-selection')
								]),
							_elm_lang$core$Native_List.fromArray(
								[
									A2(
									...
									_elm_lang$core$Native_List.fromArray(
										[
											_elm_lang$html$Html$text('Videos')
										])),
									A2(
									_elm_lang$html$Html$div,
									_elm_lang$core$Native_List.fromArray(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('video-list')
								]),
							videoList)
						]))
				]));
